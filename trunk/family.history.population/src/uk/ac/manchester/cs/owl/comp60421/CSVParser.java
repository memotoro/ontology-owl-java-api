 ...
 * @author Pavel
 * 
 * This class parses CSV files. Don't change it. Please report any bugs/questions to the author (pklinov@cs.man.ac.uk)
 *
 *
 */
public class CSVParser {
	 ...
	 * @throws IOException if any problem occurrs with reading the file
	 */
